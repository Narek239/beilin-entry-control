...
public final class BlockChangeRecorder1201 {
	...
	public static ActorContext.Scope beginWorldEditHistory(Object actor, String source) {
		if (!recordWorldEditBulkPlacements) return null;
		return ActorContext.pushBulkRecord(BulkPlacementIntrospection.actorName(actor), source, BlockChangeRecorder1201::flushBulkAudit);
	}
	...
	public static ActorContext.Scope beginEffortlessHistory(Object player, String source) {
		...
		return ActorContext.pushBulkRecord(BulkPlacementIntrospection.actorName(player), source, BlockChangeRecorder1201::flushBulkAudit);
	}
