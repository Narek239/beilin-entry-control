...
public final class BlockChangeRecorder1201 {
	...
	public static void configureBulkOptions(
		...
		BlockChangeRecorder1201.recordWorldEditBulkPlacements = recordWorldEditBulkPlacements;
		BlockChangeRecorder1201.recordEffortlessBulkPlacements = recordEffortlessBulkPlacements;
		BlockChangeRecorder1201.discardLinearBulkPlacements = discardLinearBulkPlacements;
	}
	...
	public static ActorContext.Scope beginWorldEditHistory(Object actor, String source) {
		if (!recordWorldEditBulkPlacements) return null;
		return ActorContext.pushBulkRecord(BulkPlacementIntrospection.actorName(actor), source, BlockChangeRecorder1201::flushBulkChanges);
	}
	...
	public static ActorContext.Scope beginEffortlessHistory(Object player, String source) {
		...
		return ActorContext.pushBulkRecord(BulkPlacementIntrospection.actorName(player), source, BlockChangeRecorder1201::flushBulkChanges);
	}
	...
	private static ActorContext.Scope beginBulkDeleteBounds(String actorName, String source, BulkPlacementBounds bounds) {
		if (bounds == null) return ActorContext.pushBulkRecord(actorName, source, BlockChangeRecorder1201::flushBulkChanges);
