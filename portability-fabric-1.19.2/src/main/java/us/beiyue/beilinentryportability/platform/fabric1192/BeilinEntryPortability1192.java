package us.beiyue.beilinentryportability.platform.fabric1192;
...
public final class BeilinEntryPortability1192 implements ModInitializer {
	...
	public void onInitialize() {
		...
		if (!addonConfig.exportProcessingEnabled) {
			LOGGER.info("Beilin Entry Portability is installed. Recording={}, export processing disabled. Edit {} to enable WebSocket export processing.", addonConfig.recordingEnabled, PortabilityAddonConfig1192.configPath());
		}
		if (addonConfig.exportProcessingEnabled && !controlConfig.isApiKeyConfigured()) {
			LOGGER.warn("Beilin Entry Portability cannot start because {} has no valid apiKey.", SharedControlConfig1192.configPath());
		}
