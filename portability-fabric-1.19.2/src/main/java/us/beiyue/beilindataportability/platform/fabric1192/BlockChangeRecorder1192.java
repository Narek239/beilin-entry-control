...
public final class BlockChangeRecorder1192 {
	...
	public static void configureBulkOptions(
		...
		BlockChangeRecorder1192.recordWorldEditBulkPlacements = recordWorldEditBulkPlacements;
		BlockChangeRecorder1192.recordEffortlessBulkPlacements = recordEffortlessBulkPlacements;
		BlockChangeRecorder1192.discardLinearBulkPlacements = discardLinearBulkPlacements;
	}
	...
	public static ActorContext.Scope beginWorldEditHistory(Object actor, String source) {
		if (!recordWorldEditBulkPlacements) return null;
		return ActorContext.pushBulkRecord(BulkPlacementIntrospection.actorName(actor), source, BlockChangeRecorder1192::flushBulkChanges);
	}
	...
	public static ActorContext.Scope beginEffortlessHistory(Object player, String source) {
		...
		return ActorContext.pushBulkRecord(BulkPlacementIntrospection.actorName(player), source, BlockChangeRecorder1192::flushBulkChanges);
	}
	...
	public static void recordSetBlock(Level level, BlockPos pos, BlockState oldState, BlockState newState) {
		...
		boolean oldBlockReplaceable = oldState != null && oldState.getMaterial().isReplaceable();
